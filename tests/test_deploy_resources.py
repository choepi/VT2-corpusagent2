...
from corpusagent2.deploy_resources import GIB, HostHardware, compose_files_for_stack, compute_docker_resource_plan
...
def test_large_host_uses_smaller_fraction_and_can_enable_gpu() -> None:
    ...
    assert plan.env["CORPUSAGENT2_OPENSEARCH_JAVA_OPTS"].startswith("-Xms")
